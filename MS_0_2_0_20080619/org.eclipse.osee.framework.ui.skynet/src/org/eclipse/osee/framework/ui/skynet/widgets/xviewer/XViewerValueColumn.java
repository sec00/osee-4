...
public class XViewerValueColumn extends XViewerColumn {
   ...
   public XViewerValueColumn(XViewer viewer, String name, int width, int defaultWidth, int align, boolean show, SortDataType sortDataType, int orderNum) {
      super(viewer, name, width, defaultWidth, align, show, sortDataType, orderNum);
   }

   public XViewerValueColumn(String name, int width, int defaultWidth, int align, boolean show, SortDataType sortDataType, int orderNum) {
      super(name, width, defaultWidth, align, show, sortDataType, orderNum);
   }
