...
public class CreateSystemBranches {
   ...
   private void populateCommonBranch(String typeModel) {
      ...
      ArtifactId globalPreferences =
         tx.createArtifact(CoreArtifactTypes.GlobalPreferences, CoreArtifactTypes.GlobalPreferences.getName());
      tx.setSoleAttributeValue(globalPreferences, CoreAttributeTypes.GeneralStringData, JSON_ATTR_VALUE);

      tx.createArtifact(CoreArtifactTypes.XViewerGlobalCustomization,
