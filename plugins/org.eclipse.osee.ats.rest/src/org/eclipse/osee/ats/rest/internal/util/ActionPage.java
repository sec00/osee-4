...
public class ActionPage {
   ...
   public ActionPage(Log logger, IAtsServer atsApi, IAtsWorkItem workItem, boolean details) {
      this(logger, atsApi, (ArtifactReadable) workItem.getStoreObject(), details);
      this.workItem = workItem;
   }

   public ActionPage(Log logger, IAtsServer atsApi, ArtifactReadable action, boolean details) {
      this.logger = logger;
      this.atsApi = atsApi;
      this.action = action;
   ...
   public static String getTeamStr(IAtsServer atsApi, ArtifactReadable action) {
      String results = "";
