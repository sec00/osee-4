 ...
 * such a case is a Git repository that has a signle commit multiple times in its history causing a file to be added are
 * it already exists
 */
public class FullHistoryTolerant implements HistoryImportStrategy {
   ...
   protected final ArtifactId repoArtifact;

   public FullHistoryTolerant(ArtifactId repoArtifact, TupleQuery tupleQuery) {
