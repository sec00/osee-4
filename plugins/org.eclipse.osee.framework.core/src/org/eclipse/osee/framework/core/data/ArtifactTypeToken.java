...
import org.eclipse.osee.framework.core.enums.AttributeMultiplicity;
...
public interface ArtifactTypeToken extends NamedId, ArtifactTypeId {
   ...
   public static ArtifactTypeToken valueOf(long id, String name, ArtifactTypeToken... superTypes) {
      return valueOf(id, false, name, null, superTypes);
   }
   ...
   public static ArtifactTypeToken valueOf(long id, boolean isAbstract, String name, AttributeMultiplicity attributeTypes, ArtifactTypeToken... superTypes) {
