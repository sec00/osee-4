 ...
 */
public class ChangeEditorPreferences {
   ...
   public ChangeEditorPreferences(String nodeID) {
      ...
      try {
         if (instanceNode.nodeExists(nodeID)) {
            ((IEclipsePreferences) instanceNode.node(nodeID)).addPreferenceChangeListener(singletonPreferenceChangeListener());
         }
   ...
   private void bind(IEclipsePreferences instanceNode) {
      instanceNode.addNodeChangeListener(new IEclipsePreferences.INodeChangeListener() {

         public void added(NodeChangeEvent event) {
            if (event.getChild().name().equals(nodeID)) {
