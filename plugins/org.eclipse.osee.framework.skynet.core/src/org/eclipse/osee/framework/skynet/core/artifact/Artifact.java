...
public class Artifact extends FullyNamedIdentity<String> implements IArtifact, Adaptable {
   ...
   public final <T> Attribute<T> internalInitializeAttribute(AttributeTypeId attributeType, int attributeId, int gammaId, ModificationType modificationType, boolean markDirty, Object... data) {
      return internalInitializeAttribute(attributeType, AttributeId.valueOf(attributeId), gammaId, modificationType,
         markDirty, data);
   }

   public final <T> Attribute<T> internalInitializeAttribute(AttributeTypeId attributeType, AttributeId attributeId, int gammaId, ModificationType modificationType, boolean markDirty, Object... data) {
      Attribute<T> attribute = createAttribute(attributeType);
