...
public class EditAttributeWizardPage extends WizardPage {
	...
	public EditAttributeWizardPage(AttributeConflict conflict) {
		...
		if (!conflict.isWordAttribute()) {
			editor = EmbededAttributeEditorFactory.getEmbeddedEditor(
					changeType, conflict.getSourceDisplayData(), Arrays
							.asList(conflict), true);
		}
	}
	...
	public void createControl(Composite parent) {
		...
		new Label(composite, SWT.NONE).setText(ConflictResolutionWizard.INDENT
		...
		sourceButton = createButton(SOURCE_BUTTON_TEXT, SOURCE_TOOLTIP,
				buttonComp);
